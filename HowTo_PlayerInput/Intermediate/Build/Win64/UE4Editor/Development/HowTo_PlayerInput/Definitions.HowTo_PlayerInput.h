...
#define ORIGINAL_FILE_NAME "UE4Editor-HowTo_PlayerInput.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME HowTo_PlayerInput
#define DEPRECATED_FORGAME DEPRECATED
#define HOWTO_PLAYERINPUT_API DLLEXPORT
